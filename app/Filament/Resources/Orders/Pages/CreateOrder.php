        ...
        return DB::transaction(function () use ($data) {
           ...
           //dd($data);
            ...
            foreach ($data['orderItems'] ?? [] as $itemData) {
                ...
                $template = Production::find($itemData['production']) ?? null;
                ...
                if (!empty($itemData['create_production'])) {
                    $production = Production::create([
                        'name' => $itemData['production_name'] ?? 'Виробництво без назви просто виробництво',
                    ...
                    foreach ($itemData['production_materials'] ?? [] as $matData) {
                        ...
                        ProductionMaterial::create([
                            ...
                            'warehouse_id' => 1, // можеш вибирати зі складу з форми
                            'quantity' => $qty,
                            'unit_cost' => $unitCost,
                            'total_cost' => $sum,
                            'status' => 'на складі',
